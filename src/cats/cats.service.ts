...
export class CatsService {
  constructor(@InjectRepository(CatEntity) private catsRepository: Repository<CatEntity>) {}
  ...
  async findAll(): Promise<CatEntity[]> {
    return this.catsRepository.find().then((cats) => cats.map(CatMapper.toDomain))
  }
